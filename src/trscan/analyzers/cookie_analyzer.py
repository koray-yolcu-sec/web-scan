...
class CookieAnalyzer:
    ...
    def analyze(self, cookies: list[dict]) -> tuple[list[CookieInfo], list[Finding]]:
        ...
        for cookie in cookies:
            cookie_info = CookieInfo(
                ...
                is_session=self._is_session_cookie(
                    cookie["name"], cookie["max_age"], session_cookie_names
                ),
    ...
    def _is_session_cookie(self, name: str, max_age: int | None, session_names: list[str]) -> bool:
