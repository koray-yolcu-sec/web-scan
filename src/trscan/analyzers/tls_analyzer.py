...
from ..models.scan_result import TLSInfo, Finding
...
class TLSAnalyzer:
    ...
    def analyze(self, fetcher_result: Dict) -> Tuple[TLSInfo, List[Finding]]:
        ...
        headers = fetcher_result.get('headers', {})
    ...
    def _check_certificate_expiry(self, expiry_date: Optional[datetime]) -> Tuple[bool, Optional[int]]:
        """
